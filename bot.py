...
TOKEN = "8543678011:AAGke1hOGcqrQ91rJzTvLoSqpliNmx4Pxys"  # ⚠️ Замените на ваш токен!
...
def devices_keyboard():
    ...
    markup = types.InlineKeyboardMarkup()
    markup.row(
        types.InlineKeyboardButton("🔄 Многоразовые", callback_data="cat_reusable"),
        types.InlineKeyboardButton("⚡ Одноразовые", callback_data="cat_disposable")
    )
